...
/* Bloc 34 : banques de WUD, COR et LNT, générées par tools/questions.py. */
...
{id:'WUD-01', site:'WUD',
  ...
  exp:'Le bassin houiller de Wuda, exploité pour son charbon, se trouve en Mongolie-Intérieure.',
...
{id:'WUD-02', site:'WUD',
  ...
  exp:'La couche de cendres est datée de 298,34 Ma, soit tout au début du Permien, pratiquement sur la limite avec le Carbonifère.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-03', site:'WUD',
  ...
  exp:'Une éruption a couvert la forêt de cendres assez vite pour que les plantes n’aient pas le temps de tomber ni de pourrir.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-04', site:'WUD',
  ...
  r:'Pour son charbon',
  exp:'Le charbon exploité ici est la forêt elle-même, comprimée par le poids des sédiments qui l’ont recouverte.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-05', site:'WUD',
  ...
  exp:'Un gisement de charbon est une ancienne tourbière : de la matière végétale accumulée puis compactée pendant des millions d’années.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-06', site:'WUD',
  ...
  exp:'Ailleurs, les plantes fossiles ont été transportées avant d’être enfouies. Ici, elles ont été ensevelies à peu près là où elles poussaient.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-07', site:'WUD',
  ...
  exp:'Une feuille isolée, un fragment de tronc : le transport par l’eau disperse et trie, si bien qu’on récupère rarement une plante entière.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-08', site:'WUD',
  ...
  exp:'Connaître la position de chaque plante permet de relever la canopée, le sous-bois, et ce qui grimpait sur quoi — pas seulement la liste des espèces.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-09', site:'WUD',
  q:'Quelle plante porte des cicatrices foliaires en forme de sceaux ?',
  choix:['Sigillaria', 'Palaeostachya', 'Scolecopteris', 'Paratingia'],
  r:'Sigillaria',
  exp:'Ces cicatrices régulières sont les points d’attache des feuilles tombées, disposées en rangées le long du tronc.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-10', site:'WUD',
  q:'À quel groupe appartient Sigillaria ?',
  choix:['Aux lycophytes', 'Aux gymnospermes', 'Aux fougères', 'Aux prêles'],
  r:'Aux lycophytes',
  exp:'Les lycophytes sont aujourd’hui de petites plantes rampantes ; au Paléozoïque, certaines atteignaient vingt mètres.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-11', site:'WUD',
  ...
  exp:'Sa tige est mince : ce qui donne l’épaisseur du tronc est un manteau de racines adventives qui l’enveloppe.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-12', site:'WUD',
  ...
  exp:'Les prêles actuelles mesurent quelques dizaines de centimètres. Palaeostachya en était un parent de plusieurs mètres.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-13', site:'WUD',
  ...
  r:'En verticilles',
  exp:'Les branches partent toutes du même niveau, en couronne autour de la tige — une disposition caractéristique du groupe.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-14', site:'WUD',
  ...
  r:'Des spores',
  exp:'C’est ce qui rend la plante instructive : l’organe ressemble à un cône de conifère, mais il libère des spores.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-15', site:'WUD',
  ...
  exp:'Les noeggerathiales sont rattachées aux progymnospermes, groupe frère des plantes à graines : elles annoncent la graine sans la produire.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-16', site:'WUD',
  ...
  exp:'Elle s’enroulait autour des fougères arborescentes, ce qui suppose déjà une forêt assez dense pour qu’il vaille la peine de grimper.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-17', site:'WUD',
  ...
  exp:'Le spécimen porte des morsures, des galles et des pontes — trois types de traces laissées par des insectes.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-18', site:'WUD',
  ...
  exp:'Une galle est une réaction de la plante à un parasite : elle prouve une interaction, pas seulement une cohabitation.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-19', site:'WUD',
  ...
  exp:'« cf. » signifie « à comparer avec » : le fossile ressemble à cette espèce sans que l’attribution soit établie.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']},
{id:'WUD-20', site:'WUD',
  ...
  exp:'Lycophytes, fougères, sphénophytes et plantes à graines résolvent le même problème — se tenir droit et capter la lumière — par des architectures différentes.',
  src:['Wang et al. 2012 — Permian vegetational Pompeii, PNAS','https://www.pnas.org/doi/10.1073/pnas.1115076109']});
...
{id:'COR-01', site:'COR',
  ...
  exp:'Gotland est une île suédoise de la Baltique, à la latitude de Stockholm.',
...
{id:'COR-02', site:'COR',
  ...
  r:'Au Silurien',
  exp:'Le Silurien s’étend de 443 à 419 Ma. Le calcaire de l’île s’est formé pendant cette période.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-03', site:'COR',
  ...
  exp:'Ce morceau de croûte se trouvait alors vers vingt degrés de latitude sud, dans une mer chaude et peu profonde.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-04', site:'COR',
  ...
  exp:'La tectonique des plaques a déplacé le continent depuis : la latitude d’une roche aujourd’hui ne dit rien de celle où elle s’est formée.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-05', site:'COR',
  ...
  r:'Du récif lui-même',
  exp:'Le calcaire de Gotland n’est pas un dépôt recouvrant le récif : c’est le récif lui-même, transformé en roche.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-06', site:'COR',
  ...
  exp:'Les Rugosa sont les coraux dits rugueux, les Tabulata les coraux tabulés. Ce sont les deux grands bâtisseurs du Paléozoïque.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-07', site:'COR',
  ...
  exp:'Ils se sont éteints à la fin du Permien, lors de la plus grande crise biologique connue, sans laisser de descendance.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-08', site:'COR',
  ...
  exp:'Les coraux modernes, les Scleractinia, apparaissent au Trias, après l’extinction des deux groupes précédents.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-09', site:'COR',
  ...
  r:'Une convergence',
  exp:'Une convergence, c’est quand des lignées différentes aboutissent à la même solution. Le récif a été réinventé, pas hérité.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-10', site:'COR',
  ...
  r:'Halysites',
  exp:'Ses corallites sont accolés en files, et une coupe fait apparaître des maillons alignés.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-11', site:'COR',
  q:'Que signifie le nom d\'Halysites ?',
  choix:['« En chaîne »', '« À gros polypes »', '« De Gotland »', '« En éventail »'],
  r:'« En chaîne »',
  exp:'« Halysites » vient du grec halysis, la chaîne. Le nom a été donné par Linné en 1767.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-12', site:'COR',
  ...
  exp:'Les corallites hexagonaux, serrés les uns contre les autres, produisent une surface régulière en alvéoles.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-13', site:'COR',
  ...
  r:'Une corne',
  exp:'C’est un rugueux solitaire : un cône évasé vers le haut, qui pousse en s’élargissant depuis sa pointe.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-14', site:'COR',
  ...
  exp:'Sur un fond meuble et trouble, tenir debout est le problème principal. Il s’ancrait entre les rangs d’une colonie voisine, dont il tuait les petits polypes pour se faire de la place.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-15', site:'COR',
  ...
  exp:'Il mesure un à deux centimètres et n’est pas fixé : il repose librement sur le sédiment. Sa présence caractérise les Lower Visby Beds.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-16', site:'COR',
  ...
  exp:'Les rugueux sont le plus souvent solitaires. Entelophyllum fait exception, avec ses longs tubes séparés divergeant depuis la base.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-17', site:'COR',
  ...
  exp:'Un large calice en forme de champignon. La révision du genre signale toutefois des spécimens coloniaux ou agrégés : sa nature n’est pas tranchée.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-18', site:'COR',
  ...
  r:'Un seul polype',
  exp:'Un corail solitaire est un animal unique dans son squelette, là où une colonie en abrite des milliers reliés entre eux.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-19', site:'COR',
  ...
  exp:'Un récif crée du relief, des cavités, des surfaces dures. Schlotheimophyllum porte à lui seul vingt-trois espèces d’organismes encroûtants.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']},
{id:'COR-20', site:'COR',
  ...
  exp:'Chaîne, nid-d’abeilles, corne, bouton, buisson : la forme se retient et se compare, le nom vient ensuite.',
  src:['Zapalski & Król — Silurian Halysites biostrome, Lethaia','https://www.scup.com/doi/full/10.1111/let.12279']});
...
{id:'LNT-01', site:'LNT',
  ...
  exp:'La formation de Lantian affleure près de Xiuning, dans la province de l’Anhui.',
...
{id:'LNT-02', site:'LNT',
  ...
  choix:['D\'environ 600 Ma', 'D\'environ 400 Ma', 'D\'environ 250 Ma', 'D\'environ 900 Ma'],
  r:'D\'environ 600 Ma',
  exp:'L’âge tourne autour de 600 Ma, mais la datation n’est pas fixée et le biote pourrait être plus jeune.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-03', site:'LNT',
  q:'À quelle période appartiennent-ils ?',
  choix:['À l\'Édiacarien', 'Au Cambrien', 'Au Cryogénien', 'À l\'Ordovicien'],
  r:'À l\'Édiacarien',
  exp:'L’Édiacarien est la dernière période avant le Cambrien, et la première où des organismes de grande taille apparaissent.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-04', site:'LNT',
  ...
  r:'Rien de visible',
  exp:'Les continents étaient nus : ni plantes, ni sols, ni animaux terrestres. Toute la vie complexe était marine.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-05', site:'LNT',
  ...
  exp:'Avant eux, la vie est essentiellement microscopique. Ici, pour la première fois, des êtres qu’un promeneur aurait pu voir sans instrument.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-06', site:'LNT',
  ...
  exp:'Des cellules isolées, des filaments, des tapis microbiens — visibles en masse, jamais individuellement.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-07', site:'LNT',
  ...
  exp:'Un fond vaseux et sombre, sous une tranche d’eau modeste, où ces organismes étaient fixés.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-08', site:'LNT',
  ...
  exp:'Ils sont aplatis dans la roche et réduits à un film de carbone : la silhouette subsiste, l’épaisseur non.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-09', site:'LNT',
  q:'Quel organisme forme un éventail de filaments parallèles ?',
  choix:['Flabellophyton', 'Orbisiana', 'Baculiphyca', 'Anhuiphyton'],
  r:'Flabellophyton',
  exp:'Un grand thalle en éventail formé de filaments parallèles, fixé par une base globuleuse.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-10', site:'LNT',
  ...
  exp:'Chaque branche se sépare en deux branches égales, qui se séparent à leur tour — d’où une arborescence très régulière.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-11', site:'LNT',
  ...
  exp:'Sa ramification est d’une régularité presque schématique, et c’est un des rares caractères que la compression conserve fidèlement.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-12', site:'LNT',
  ...
  exp:'De longues lames ou rubans souples, qui devaient onduler dans le courant.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-13', site:'LNT',
  ...
  exp:'Des modules globuleux ou cylindriques alignés en longues chaînes, parfois ramifiées.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-14', site:'LNT',
  ...
  exp:'On le range parmi les algues par défaut, mais rien ne le démontre. C’est le cas le plus ouvert du chantier.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-15', site:'LNT',
  ...
  exp:'Un atlas qui n’inclurait que les cas réglés donnerait une idée fausse du métier : l’incertitude en fait partie.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-16', site:'LNT',
  ...
  exp:'« sp. » signale que le genre est établi mais que l’espèce n’a pas été déterminée.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-17', site:'LNT',
  ...
  exp:'Une compression conserve le contour et parfois la ramification, mais ni la couleur, ni la souplesse, ni l’épaisseur des tissus.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-18', site:'LNT',
  ...
  exp:'Comme des propositions et non des portraits : la forme est fondée, le reste est une reconstitution raisonnée.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-19', site:'LNT',
  ...
  exp:'Non. Les plantes terrestres apparaîtront plus de deux cents millions d’années plus tard. Ce sont des organismes marins d’affinité algale probable.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']},
{id:'LNT-20', site:'LNT',
  ...
  exp:'Lantian devient le chantier le plus ancien de l’atlas et en prend la tête, devant la Mer Blanche.',
  src:['Yuan et al. — The Lantian biota, Science Bulletin','https://link.springer.com/article/10.1007/s11434-012-5483-6']});
...
/* Bloc 36 : banques de KAP, LIV et DOM, générées par tools/questions.py. */
...
{id:'KAP-01', site:'KAP',
  ...
  exp:'Le gisement se trouve en Peary Land, au-delà du 82ᵉ parallèle. Il n’existe pas d’endroit habité plus au nord.',
...
{id:'KAP-02', site:'KAP',
  ...
  r:'D\'environ 2 Ma',
  exp:'Environ deux millions d’années, à la transition entre le Pliocène et le Pléistocène.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-03', site:'KAP',
  ...
  exp:'Un désert polaire : pas d’arbres, presque pas de terre meuble, quelques mois de lumière par an.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-04', site:'KAP',
  ...
  exp:'Une mosaïque de forêt claire, de landes, de marais et d’estuaires, sous des températures de onze à dix-neuf degrés supérieures aux actuelles.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-05', site:'KAP',
  ...
  exp:'Des bouleaux, des thuyas et des peupliers — une forêt boréale ouverte, à quelques degrés du pôle Nord.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-06', site:'KAP',
  ...
  exp:'À partir d’ADN conservé dans le sédiment, et non de squelettes. Le gisement est presque sans fossiles.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-07', site:'KAP',
  ...
  exp:'L’ADN environnemental ancien : des fragments génétiques laissés dans le milieu par les organismes qui y vivaient.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-08', site:'KAP',
  ...
  exp:'En se liant à des surfaces minérales, ce qui l’a protégé de la dégradation. C’est le plus ancien ADN jamais séquencé.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-09', site:'KAP',
  ...
  exp:'Elle détecte aussi les organismes sans squelette solide, qui ne laissent aucun fossile.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-10', site:'KAP',
  ...
  exp:'Seuls les os, les dents et les coquilles se conservent : tout le reste du vivant échappe au dénombrement.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-11', site:'KAP',
  ...
  exp:'Elle dit qu’un mastodonte était là, pas à quoi il ressemblait ni de quelle espèce il s’agissait.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-12', site:'KAP',
  ...
  exp:'L’ADN disponible ne descend pas plus bas. Nommer une espèce serait affirmer plus que ce que la méthode autorise.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-13', site:'KAP',
  ...
  exp:'Une branche ancienne des proboscidiens, distincte de celle des mammouths et des éléphants actuels.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-14', site:'KAP',
  ...
  r:'Une forêt',
  exp:'Une forêt claire — bien plus arborée que la toundra où on trouve les rennes aujourd’hui.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-15', site:'KAP',
  ...
  exp:'Une même sous-famille réunit campagnols, lemmings et rats musqués : le rongeur est l’un d’eux, sans qu’on sache lequel.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-16', site:'KAP',
  ...
  exp:'Pour ce spécimen, l’ADN s’arrête à la sous-famille. La fiche s’arrête donc là aussi.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-17', site:'KAP',
  ...
  exp:'Une mer sans banquise permanente : la limule, avec des algues vertes, atteste d’eaux nettement plus chaudes.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-18', site:'KAP',
  ...
  exp:'C’est un parent. Le nom de fichier porte celui de l’espèce actuelle apparentée, faute d’identification à l’espèce.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-19', site:'KAP',
  ...
  exp:'Sur des parents connus, puisqu’aucune anatomie n’est conservée. Elles doivent se lire ainsi.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']},
{id:'KAP-20', site:'KAP',
  ...
  exp:'Le même point sur la carte portait une forêt il y a deux millions d’années et un désert polaire aujourd’hui.',
  src:['Kjær et al. 2022 — A 2-million-year-old ecosystem in Greenland, Nature','https://www.nature.com/articles/s41586-022-05453-y']});
...
{id:'LIV-01', site:'LIV',
  ...
  exp:'Elles sont vivantes aujourd’hui. C’est le seul chantier de l’atlas où l’on ne creuse pas.',
...
{id:'LIV-02', site:'LIV',
  ...
  exp:'Un pêcheur y a remonté en 1938 un cœlacanthe, poisson que l’on croyait disparu depuis soixante-six millions d’années.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-03', site:'LIV',
  ...
  exp:'Océan Indien, Nouvelle-Zélande, Indo-Pacifique, Australie, mares temporaires d’Eurasie : l’épingle est un repère, pas un gisement.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-04', site:'LIV',
  ...
  exp:'Une allure qui évoque les mers anciennes — coquille cloisonnée, carapace à épine, appendices caudaux.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-05', site:'LIV',
  ...
  exp:'L’expression est de Darwin, en 1859, et il jugeait lui-même l’étiquette fantaisiste dans la phrase suivante.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-06', site:'LIV',
  ...
  r:'Leur lignée',
  exp:'Leur lignée, et leur plan d’organisation. Les espèces actuelles, elles, sont récentes.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-07', site:'LIV',
  ...
  exp:'La façon dont le corps est bâti : la disposition générale des parties, indépendamment de l’espèce.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-08', site:'LIV',
  ...
  r:'Non',
  exp:'Non. Une famille peut être vieille de quatre cents millions d’années tandis que chacun de ses membres actuels est jeune.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-09', site:'LIV',
  ...
  exp:'Oui, et c’est ce qui rend la distinction concrète : notre lignée est ancienne, notre espèce ne l’est pas.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-10', site:'LIV',
  q:'Quand a-t-on identifié un cœlacanthe vivant ?',
  choix:['En 1938', 'En 1836', 'En 1998', 'En 1872'],
  r:'En 1938',
  exp:'En 1938, quand un spécimen remonté aux Comores a été identifié.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-11', site:'LIV',
  ...
  exp:'Qu’il avait disparu à la fin du Crétacé. Il n’était connu que par ses fossiles.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-12', site:'LIV',
  ...
  exp:'En jouant sur le gaz contenu dans les loges cloisonnées de sa coquille.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-13', site:'LIV',
  ...
  r:'Respirer de l\'air',
  exp:'Respirer l’air grâce à un poumon fonctionnel, en plus de ses branchies.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-14', site:'LIV',
  q:'De quel groupe les dipneustes sont-ils proches ?',
  choix:['De nous', 'Des requins', 'Des anguilles', 'Des amphibiens uniquement'],
  r:'De nous',
  exp:'De nous. Les dipneustes sont plus proches des tétrapodes que des poissons ordinaires.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-15', site:'LIV',
  ...
  exp:'Non. C’est un rhynchocéphale, dernier survivant d’un groupe très répandu au Mésozoïque.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-16', site:'LIV',
  ...
  exp:'Plus de deux cents millions d’années séparent les rhynchocéphales des lézards : la ressemblance est trompeuse.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-17', site:'LIV',
  ...
  r:'Elle a peu changé',
  exp:'Qu’elle a peu changé — ce qui ne veut pas dire qu’elle a cessé de changer.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-18', site:'LIV',
  q:'La limule a-t-elle cessé d\'évoluer ?',
  choix:['Non', 'Oui, depuis le Trias', 'Oui, depuis le Dévonien', 'Non, elle a rajeuni'],
  r:'Non',
  exp:'Non. Les limulidés se révèlent génétiquement plus diversifiés qu’on ne le pensait.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-19', site:'LIV',
  ...
  exp:'Dans des mares temporaires, qui s’assèchent puis se remplissent. Ses œufs résistent à la dessiccation.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']},
{id:'LIV-20', site:'LIV',
  ...
  exp:'Ailleurs on regarde des formes disparues en imaginant ce qu’elles étaient vivantes ; ici on regarde des vivants en y reconnaissant des formes qu’on croyait révolues.',
  src:['Herrera-Flores et al. — Quantifying the living fossil concept, Palaeontologia Electronica','https://palaeo-electronica.org/content/2018/2194-quantifying-the-living-fossil']});
...
{id:'DOM-01', site:'DOM',
  ...
  exp:'Il y a environ douze mille ans, avec le chien puis les premiers animaux d’élevage.',
...
{id:'DOM-02', site:'DOM',
  ...
  r:'À l\'Holocène',
  exp:'À l’Holocène, l’époque en cours, qui commence il y a environ onze mille sept cents ans.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-03', site:'DOM',
  ...
  exp:'Des formes très proches existaient déjà au Pléistocène : un renard seul ne date rien.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-04', site:'DOM',
  q:'Qu\'est-ce qui, au contraire, ne trompe pas ?',
  choix:['Un teckel', 'Un loup gris', 'Un sanglier d\'Europe', 'Un cerf élaphe'],
  r:'Un teckel',
  exp:'Un teckel. Cette anatomie n’aurait jamais été produite par la sélection naturelle seule.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-05', site:'DOM',
  q:'Quel est le premier animal domestiqué du pack ?',
  choix:['Le chien', 'Le mouton', 'Le cheval', 'Le dromadaire'],
  r:'Le chien',
  exp:'Le chien. L’ordre de ce pack suit le processus, et c’est pourquoi son emblème n’est pas en première position.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-06', site:'DOM',
  ...
  r:'Oui',
  exp:'Oui, tous deux Canis lupus familiaris. Ils peuvent se reproduire ensemble.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-07', site:'DOM',
  q:'Comment appelle-t-on les variétés d\'une même espèce domestique ?',
  choix:['Des races', 'Des sous-espèces', 'Des genres', 'Des familles'],
  r:'Des races',
  exp:'Des races. La diversité montrée par ce chantier est en grande partie interne à quelques espèces.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-08', site:'DOM',
  ...
  exp:'Elle pousse sans s’arrêter, là où le pelage des moutons sauvages muait.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-09', site:'DOM',
  ...
  exp:'Il dépend de la tonte : sans intervention humaine, la toison continue de croître.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-10', site:'DOM',
  ...
  r:'Pour son lait',
  exp:'Pour son lait, en quantité très supérieure aux besoins d’un veau.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-11', site:'DOM',
  ...
  r:'Pour la traction',
  exp:'Pour la traction : encolure puissante, poitrine large, membres épais.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-12', site:'DOM',
  ...
  r:'Massive et large',
  exp:'Massive et large, entièrement orientée vers la force plutôt que vers la vitesse.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-13', site:'DOM',
  ...
  exp:'Aux régions arides, aux caravanes et au pastoralisme.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-14', site:'DOM',
  ...
  exp:'Pratiquement aucun. Les populations libres actuelles sont des animaux retournés à la vie sauvage.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-15', site:'DOM',
  ...
  r:'Qui se reproduit',
  exp:'Qui se reproduit. L’humain ne crée pas la variation, il choisit celle qui lui convient.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-16', site:'DOM',
  ...
  exp:'Par l’agent, pas par le mécanisme : c’est toujours de la sélection, mais quelqu’un la dirige.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-17', site:'DOM',
  ...
  r:'La vitesse',
  exp:'La vitesse. Ce qui demandait des milliers de générations peut être obtenu en quelques dizaines.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-18', site:'DOM',
  ...
  exp:'Ce qu’une seule espèce peut donner. Les moutons, eux, ont gardé une diversité génétique élevée : la sélection n’appauvrit pas toujours.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-19', site:'DOM',
  ...
  r:'Non',
  exp:'Non. Ces questions sont réelles mais elles ne se tranchent pas avec un fossile.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']},
{id:'DOM-20', site:'DOM',
  ...
  exp:'Qu’une espèce est devenue capable de remodeler délibérément le corps d’autres espèces.',
  src:['Driscoll et al. 2009 — An evolutionary view of domestication, PNAS','https://www.pnas.org/doi/10.1073/pnas.0901586106']});

/* ================================================================
   Bloc 37 : ce que la fouille achète, et à quel prix.

   CONSTAT. Le contenu de l'atlas a triplé, mais il restait derrière
   un péage conçu pour une joueuse qui collectionne. Louise ne
   collectionne pas : ce qui la ramène, ce sont les textes. Le barème
   avait donc pour effet net de lui cacher précisément ce pour quoi
   elle ouvre l'application.

   DEUX CHANGEMENTS, sans toucher au moteur.

   1. FICHES_LIBRES — les fiches de créatures sont lisibles tout de
      suite, sans avoir été trouvées. La fouille ne déverrouille plus
      le savoir ; elle marque ce que l'on a travaillé. Les compteurs
      « 0 / 6 », la collection et la progression du profil continuent
      de refléter les trouvailles réelles : on voit toujours où l'on
      en est, on n'est simplement plus privé de lecture.

      Le masquage reste écrit et fonctionnel : passer ce drapeau à
      false rétablit exactement la mécanique précédente. C'est une
      réserve, pas du code mort.

   2. Barème 100 + 10 par chantier. Le plateau à 320 supposait qu'on
      voulait freiner l'ouverture. Ce n'est plus le cas. Le prix
      devient franchement bas et croît juste assez pour SUGGÉRER un
      ordre — l'ordre chronologique, celui de la frise — sans jamais
      l'imposer : dix crédits d'écart ne bloquent personne.

      Trente chantiers de 100 à 390, soit 7350 crédits au lieu de
      9280. Surtout, le premier tiers de l'atlas s'ouvre à 100-190,
