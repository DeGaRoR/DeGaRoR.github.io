...
## The painted signs (`assets/billboards/`, G313)

The village's signs — the store's board, the roadside billboards — are the
user's own: generated by the user (ChatGPT image), delivered as sheets of
signs on a clear ground (`assets/billboards/signs_sheet_1.png`), cut by
`tools/sign_import.py` and baked by `tools/sign_prep.js` into
