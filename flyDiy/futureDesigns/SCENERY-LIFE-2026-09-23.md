...
| **wall clutter** | against a house's back and side walls (the frontage wall 20 % of the time), corners first (55 %); a works or a hangar more; the apron's edges | recipes by the building's category: bins, the two tall propane bottles, tyres (stacked, on the tread), crates, jerrycans, a barrel, drums, cartons; a dumpster by a shop |
