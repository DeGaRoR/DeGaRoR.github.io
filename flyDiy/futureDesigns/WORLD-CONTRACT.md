...
`waterH` interior is the honest minimum (`terrainH < 0 ? 0 : −Infinity`,
sea only) and `surface` is WATER / ROCK(h ≥ 220) / GRASS — both are stage
1/2/5 replacement points, the signatures are the contract. Seed enters as
