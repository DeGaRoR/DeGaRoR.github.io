...
### D — S5: THE DYNAMIC PROBE + ONE SKY IN THE HANGAR — **LANDED 2026-09-15 (see HANDOVER, SESSION D)**
As designed, plus: the shed’s exposure is capped at the lamps’ level (LAMP_EX_CAP 1.4) — the eye adapts to the brightest source, and at night that is the lamps; the dome takes a frame yaw (the shed is a quarter turn of the world); the graded media stays on the shelf, the rows keep the lamps.
