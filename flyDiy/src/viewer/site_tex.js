...
const SITE_TEX_SETS = (typeof Image !== 'undefined') ? (() => {
  ...
  return {
    ...
    cracked: { name: 'cracked concrete', tile: 4, px: 512,
      ...
      get rough() { return mk('media/tex/site/cracked_rough_512.e6529d75.jpg'); } },
    ...
    asphalt: { name: 'asphalt', tile: 4, px: 512,
      ...
      get rough() { return mk('media/tex/site/asphalt_rough_512.ac02fc18.jpg'); } },
    asphaltaerial: { name: 'asphalt · aerial', tile: 16, px: 512,
      get diff() { return mk('media/tex/site/asphaltaerial_diff_512.96d5e567.jpg'); },
      get nor() { return mk('media/tex/site/asphaltaerial_nor_gl_512.e32bc255.jpg'); },
      get rough() { return mk('media/tex/site/asphaltaerial_rough_512.a5c0e524.jpg'); } },
    grass004: { name: 'lawn grass', tile: 2, px: 512,
      get diff() { return mk('media/tex/site/grass004_diff_512.7cc9f4c2.jpg'); },
      get nor() { return mk('media/tex/site/grass004_nor_gl_512.151550a5.jpg'); },
      get rough() { return mk('media/tex/site/grass004_rough_512.f5626b4f.jpg'); } },
    grass005: { name: 'field grass', tile: 2, px: 512,
      get diff() { return mk('media/tex/site/grass005_diff_512.452ae05b.jpg'); },
      get nor() { return mk('media/tex/site/grass005_nor_gl_512.bf66784f.jpg'); },
      get rough() { return mk('media/tex/site/grass005_rough_512.5497193f.jpg'); } },
    leafygrass: { name: 'leafy grass', tile: 2, px: 512,
      get diff() { return mk('media/tex/site/leafygrass_diff_512.8e2afea6.jpg'); },
      get nor() { return mk('media/tex/site/leafygrass_nor_gl_512.9b63c7d7.jpg'); },
      get rough() { return mk('media/tex/site/leafygrass_rough_512.0187dd5d.jpg'); } },
    ground003: { name: 'dry ground', tile: 2, px: 512,
      get diff() { return mk('media/tex/site/ground003_diff_512.c3aa8c9e.jpg'); },
      get nor() { return mk('media/tex/site/ground003_nor_gl_512.b6f78081.jpg'); },
      get rough() { return mk('media/tex/site/ground003_rough_512.ccf85026.jpg'); } },
