...
var ROCK_MAP = (() => {
  function make(THREE, ctx) {
    ...
    function bakeSprites() {
      ...
      let k = 0;
      // G570: THE MATERIALS ARE KEPT FOR THE WHOLE BAKE. One made and disposed per part released its program with
    ...
    // ONE MATERIAL FOR EVERY SPRITE OF THE MAP (G570): they were identical, made per species and disposed at every
