...
const SIGN_TEX_SETS = (typeof Image !== 'undefined') ? (() => {
  ...
  return {
    ...
    admiralty_police: { name: 'Admiralty Police', kind: 'civic', role: 'police', aspect: 2.145, px: [665, 310], img: mk('media/tex/signs/admiralty_police_1k.ba6e1e17.png') },
    island_clinic: { name: 'Island Clinic', kind: 'civic', role: 'clinic', aspect: 2.496, px: [664, 266], img: mk('media/tex/signs/island_clinic_1k.8796209e.png') },
    town_hall: { name: 'Town Hall', kind: 'civic', role: 'town hall', aspect: 2.645, px: [677, 256], img: mk('media/tex/signs/town_hall_1k.a68849c0.png') },
    fire_brigade: { name: 'Fire Brigade', kind: 'civic', role: 'fire hall', aspect: 3.294, px: [672, 204], img: mk('media/tex/signs/fire_brigade_1k.2ef9803d.png') },
    kootz_school: { name: 'Kootz Landing School', kind: 'civic', role: 'school', aspect: 2.142, px: [664, 310], img: mk('media/tex/signs/kootz_school_1k.82d079fd.png') },
    postal_service: { name: 'Postal Service', kind: 'civic', role: 'post office', aspect: 3.702, px: [707, 191], img: mk('media/tex/signs/postal_service_1k.a8f1c88e.png') },
    community_church: { name: 'Community Church', kind: 'civic', role: 'church', aspect: 2.176, px: [631, 290], img: mk('media/tex/signs/community_church_1k.b5cfd90f.png') },
    veterinary_care: { name: 'Veterinary Care', kind: 'civic', role: 'vet', aspect: 3.423, px: [688, 201], img: mk('media/tex/signs/veterinary_care_1k.11f29877.png') },
  };
})() : null;
