...
const { decodeModel, makeSkinBinding, sparDeltas, applySkinDeform } = require('./model_codec.js');
const { MODEL_PA18 } = require('./pa18_model.js');
const { buildCub, makeSim, makeAutopilot, makeWorld } = require('./flight_core.js');
...
console.log(ok ? 'SKIN GATE: GREEN' : 'SKIN GATE: RED');
process.exit(ok ? 0 : 1);
