#!/usr/bin/env node
// _cover_check.js — GATE COVER (G579): the cover ring's rocks and debris drawn as batches are the same picture
...
//   4. SHADOWS FROM 0.5 m. No prototype under castMinH (0.5 m since G579) casts, in either path.
