...
window.CAGE_PAGE = {
  defaultStep: 'crease',
  // THE JODEL — the user's own build, verbatim from their export
  // (jodelSeating.json, 2026-08-19). This IS the page default: opening
  // cage5 lands on this aeroplane, correctly sized, scale slider ×1.000.
  // THE DEFAULT AEROPLANE — the user's own build, imported verbatim from
  // their export (newDefault.json, 2026-08-24). Opening cage5 or cage6 lands
  // on THIS aeroplane; the scale slider reads x1.000 against it. Cage5 has no
  // gear or cowl layer, so those keys are simply inert there — one default
  // aeroplane, and each page shows the parts it has loaded.
  defaults: {
    // ---- THE AEROPLANE — cage ----
    planeScale: 0.745, paxLen: 0.91, pilotLen: 0.42, cabPillarW: 0.115,
    paxPillarW: 0.11, pillarW: 0.1, halfW: 0.795, roofY: 0.815,
    waistY: 0.04, aftRoofY: 0.78, aftKeelY: -0.765, tailRoofY: 0.3,
    wsRun: 0.95, wsBaseBow: 0.45, wsCeilBow: 0.3, apilW: 0.92, apilPerp: 1,
    noseLen: 0.44, noseW: 0.97, pfW: 0.3, topRound: 1, topAngRoof: 81,
    topComp: 1.03, bubble: 1, skylight: 0, crSill: 0, crBand: 3, crCap: 3,
    crNoseCap: 3, noseCrown: 0.16, noseH: 1.07, wsBaseLift: 0.05,
    noseTip: 0.25, ringCowl2W: -0.02, ringScrBot: -0.015, rimDoor: 0,
    intOn: 1, intCons: 2, dashCrease: 3, cutParts: 1,
    // ---- COWL + PROPELLER (_cage_cowl.js) ----
    cowlOn: 1, fitNose: 1, cowlGap: 0, propOn: 1, propSpin: 0,
    cw_cowlLen: 0.365, cw_aftW: 0.425, cw_aftH: 0.3, cw_taperW: 0.82,
    cw_taperH: 0.78, cw_sqAftTop: 0.82, cw_sqAftBot: 0.82,
    cw_sqFrontTop: 0.54, cw_sqFrontBot: 0.48, cw_deckH: 1, cw_keelH: 0.95,
    cw_lidRise: 0.06, cw_lidLen: 0.125, cw_lidR: 0.17, cw_lidRound: 0.53,
    cw_apMode: 1, cw_apW: 0.296, cw_apH: 0.108, cw_lipThick: 0.009,
    cw_lipInset: 0.028, cw_spinR: 0.101, cw_spinLen: 0.25,
    cw_noseOff: -0.04, cw_bladeN: 2, cw_propD: 1.91, cw_rootChord: 0.165,
    cw_tipChord: 0.05, cw_material: 0, cw_bladeStation: 0.42,
    cw_scoopOn: 1, cw_scoopLen: 0.22, cw_scoopDrop: 0.7,
    ...
    s2Drop: 0.22, s2Brake: 0, s2Steer: 1, s2Fair: 0, whProfile: 0,
    whTread: 0, whRibs: 3, whRim: 0, whBolts: 6, whCap: 1, whValve: 1,
    whBrake: 0, beamAng: 62, beamW: 0.075, beamT: 0.02, beamTaper: 0.72,
    beamBow: 1.06, beamRake: 0.1, linkAng: 58, linkArmW: 0.042,
    linkSwing: -42, linkVee: 1, linkSpread: 0.46, linkX: 0, linkPanel: 1,
    linkPanelT: 0.004, shockKind: 1, shockAt: 0.72, shockZ: 0.34,
    shockAng: 30, bungeeSpan: 0.26, oleoAng: 40, oleoDia: 0.058,
    oleoCyl: 0.55, oleoScissor: 0.052, oleoBrace: 1, oleoBraceZ: 0.42,
    twR: 0.1, twSpringLen: 0.52, twSpringDrop: 0.3, twSpringW: 0.052,
    twSpringT: 0.009, twLeaves: 3, twRake: 18, twTrail: 0.052,
    twLegDrop: 0.1, twSteer: 0, twSteerVis: 1, twHornY: 0.46,
    twHornZ: -0.3, s1_beamAng: 62, s1_beamW: 0.075, s1_beamT: 0.02,
    s1_beamTaper: 0.72, s1_beamBow: 1.06, s1_beamRake: 0.1, s1_linkAng: 25,
    s1_linkSwing: 17, s1_linkArmW: 0.042, s1_linkVee: 1,
    s1_linkSpread: 0.49, s1_linkX: 1, s1_linkPanel: 0, s1_shockKind: 1,
    s1_shockAt: 0.72, s1_shockZ: 0.17, s1_shockAng: 30,
    ...
    s1_twSpringW: 0.052, s1_twSpringT: 0.009, s1_twLeaves: 3,
    s1_twRake: 18, s1_twTrail: 0.052, s1_twLegDrop: 0.1, s1_twSteer: 0,
    s1_twSteerVis: 1, s1_twHornY: 0.46, s1_twHornZ: -0.3, s2_beamAng: 62,
    s2_beamW: 0.075, s2_beamT: 0.02, s2_beamTaper: 0.72, s2_beamBow: 1.06,
    s2_beamRake: 0.1, s2_linkAng: 58, s2_linkSwing: -42,
    s2_linkArmW: 0.042, s2_linkVee: 1, s2_linkSpread: 0.46, s2_linkX: 0,
    s2_linkPanel: 1, s2_shockKind: 1, s2_shockAt: 0.72, s2_shockZ: 0.34,
    s2_shockAng: 30, s2_bungeeSpan: 0.26, s2_oleoAng: 40,
    s2_oleoDia: 0.058, s2_oleoCyl: 0.55, s2_oleoScissor: 0.052,
    s2_oleoBrace: 1, s2_oleoBraceZ: 0.42, s2_twSpringLen: 0.32,
    s2_twSpringDrop: 0.09, s2_twSpringW: 0.072, s2_twSpringT: 0.008,
    s2_twLeaves: 1, s2_twRake: 0, s2_twTrail: 0.048, s2_twLegDrop: 0.175,
    s2_twSteer: 0, s2_twSteerVis: 1, s2_twHornY: 0.17, s2_twHornZ: 0.25,
    gearOn: 1, gearSit: 1,
    // ---- CREW + COCKPIT (_cage_crew.js) ----
    crewOn: 1, seatLayout: 1, seatTilt: 3, seatBelt: 0, seatType: 0,
    seatZ: 0.205, seatH: 0.08, seatRake: 13, seatPitch: 0.84,
