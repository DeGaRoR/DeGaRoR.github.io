...
const STRINGS = {
  fr: {
    ...
    scrMetric:"{m} {v}{u} > max {c}{u}", scrPass:"Éligible", scrFail:"Non éligible", shopUsed:"Occasions du jour", usedWear:"usure {w} %", usedSold:"Vendu", scrTier:"Palier {tr} requis", scrCount:"{p} ×{n} > max ×{c}", dbTitle:"Débriefing", dbBattery:"Batterie restante", dbDist:"Distance parcourue", dbContact:"Temps au contact", dbFlipped:"Temps retourné", endShrinkOut:"mort subite (piste rétrécie)", endRingOut:"sortie de piste", endKoFlip:"KO retourné", tournaments:"Tournois", unlimited:"Sans limite", soon:"Bientôt jouable", secLigues:"LIGUES", enter:"Entrer ›", lockedTag:"Verrouillée", newTag:"Nouveau", nConcours:"{n} concours", kEnCours:"{k} en cours", enCours:"en cours", engage:"S\u2019engager", abandon:"Abandonner", confirmAbandon:"Confirmer ?", dispute:"Disputer la manche", freeFight:"Combattre", youTag:"VOUS", foeTag:"ADVERSAIRE", vsBehaviour:"COMPORTEMENT \u00B7 CETTE MANCHE", mancheN:"MANCHE {r}/{n}", vsQual:"QUALIFICATION", vsExhib:"EXHIBITION", hudBattery:"BATT", hudHealth:"SANT\u00C9", stickVersions:"Plaques de version", stickerAuto:"Offerte \u00B7 logiciel", stickerWithSw:"Avec Logiciel {v}", lockBeaten:"Palmar\u00E8s : {n} victoires", needStar:"1\u2605 requise : {c}", lockStars:"\u00C9toiles requises dans la ligue pr\u00E9c\u00E9dente", lay_structure:"Structure", shopSerie:"S\u00E9rie", calibNote:"Mesure seule \u00B7 sans bourse ni palmar\u00E8s", botExport:"Exporter le bot", botImport:"Importer un bot", botCopied:"Fiche du bot copi\u00E9e", botImported:"{name} import\u00E9 au garage", botBadJson:"Fiche illisible", setExchange:"\u00C9change de bots", concoursOver:"Concours termin\u00E9 \u2014 r\u00E9engage-toi pour rejouer", introEyebrow:"CIRCUIT GARAGE", introTitle:"Bienvenue au garage", introBody:"Ton but : devenir champion de robot sumo.<br><br>Tu d\u00E9marres en classe <b>S</b> \u2014 les petits engins d\u2019\u00E9tabli, 1,42 kg maximum sur la balance. Gagne des manches au <b>Circuit Garage</b>, am\u00E9liore ton bot pi\u00E8ce par pi\u00E8ce, et d\u00E9croche la <b>Coupe des Puces</b> : la prime de mont\u00E9e t\u2019ouvrira les ligues M.<br><br>Un robot doit passer le <b>contr\u00F4le technique</b> pour combattre \u2014 le garage te dira toujours ce qui manque.", introGo:"C\u2019EST PARTI", recvEyebrow:"NOUVEAU CH\u00C2SSIS", recvGo:"AU GARAGE", recvStarterSub:"Ton premier robot \u2014 assembl\u00E9 sur un coin de bureau.", bareHullSub:"Coque nue \u2014 \u00E0 \u00E9quiper avant le CT.", usedRecvSub:"D\u2019occasion \u2014 assembl\u00E9, us\u00E9, pr\u00EAt \u00E0 rouler.", ctOk:"CT : FONCTIONNEL \u2713", addPart:"AJOUTER COMPOSANT", removePart:"RETIRER",  ct_propulsion:"CT : ce bot ne roule pas (propulsion manquante)", ct_motor:"CT : rien ne tourne (moteur manquant)", ct_battery:"CT : pas de jus (batterie manquante)", ct_cpu:"CT : personne aux commandes (CPU manquant)", ct_place:"CT : \u00E7a ne rentre pas sur la coque",ct_worn:"CT : {p} hors service (usure 100%)",saveReset:"Sauvegarde d'une version incompatible — nouvelle partie (l'ancienne est conservée en secours).",saveError:"Échec de sauvegarde — mémoire pleine ? La partie continue mais n'est plus enregistrée.",shopChassisAll:"Voir tous les châssis", bareHull:"{name} \u2014 coque nue livr\u00E9e au garage. \u00C0 \u00E9quiper !", welcomeEyebrow:"QUI PILOTE AUJOURD\u2019HUI ?", careerNew:"NOUVELLE CARRI\u00C8RE", careersBtn:"CARRI\u00C8RES", careerNamePh:"Nom de la carri\u00E8re", careerMeta:"Niveau {lv} \u00B7 {b} \u20AC \u00B7 {w} victoires", classe:"Classe", sPrime:"PRIME DE MONT\u00C9E \u00B7 +200 \u20AC \u2014 un sponsor t\u2019ouvre les ligues M !", lay_equipement:"\u00C9quipement", shopUsedBot:"Bot d\u2019occasion \u00B7 assembl\u00E9", dmgTitle:"D\u00E9g\u00E2ts subis", dmgNone:"Aucun d\u00E9g\u00E2t notable", dmgHS:"HS", dmgRipped:"ARRACH\u00C9", dmgChassis:"Ch\u00E2ssis", dmgRepairEst:"R\u00E9paration estim\u00E9e : {c} \u20AC", repair:"R\u00E9parer {c} \u20AC", repairAll:"Tout r\u00E9parer \u00B7 {c} \u20AC", wearPct:"usure {w} %", usedBotSold:"Vendu \u2014 nouvelle offre demain", usedBotBought:"{name} d\u2019occasion au garage \u2014 inspecte-le !", settingsTitle:"R\u00E9glages", settingsEyebrow:"ROBOCLASH \u00B7 PWA", moreCtrlHint:"Plus de contr\u00F4les disponibles apr\u00E8s am\u00E9lioration du software.", verRow_install:"Installable", verRow_maj:"Mises \u00E0 jour auto", forceUpdate:"Forcer la mise \u00E0 jour", updating:"Mise \u00E0 jour\u2026", setLang:"Langue", setVersions:"Versions", close:"Fermer", setErrlog:"Journal d\u2019erreurs", errClear:"Vider le journal", errNone:"Aucune erreur enregistr\u00E9e", verRow_build:"Build", verRow_off:"Hors-ligne", verRow_save:"Sauvegarde", verSaveV4:"instances", scrap:"Jeter", botScrapped:"{name} d\u00E9moli \u2014 pi\u00E8ces retourn\u00E9es \u00E0 l\u2019inventaire", lastBot:"Impossible : dernier bot du garage", garageInv:"Inventaire \u00B7 pi\u00E8ces libres", invEmpty:"Aucune pi\u00E8ce libre \u2014 tout est mont\u00E9",invShop:"Inventaire vide \u2014 passe \u00E0 la boutique.", invNew:"neuve", shopChassis:"Ch\u00E2ssis neufs", champRound:"Manche {r}/{n} · {rank}ᵉ", champTable:"Classement", you:"VOUS", bracketNext:"Qualifié · {r}", bracketChamp:"CHAMPION", bracketOut:"Éliminé", bracketPrize:"+{total} €", bracketTitle:"Coupe M", bracketDone:"terminée", champDone:"Saison terminée", champPrize:"{rank}ᵉ au classement · +{total} €", pn_a0:"(tôle nue)", pn_m5:"µ-Servo 20", pn_m6:"µ-Couple 45", pn_pr4:"Galets", pn_pr5:"Galets blindés", pn_pr6:"Larges lisses", pn_pr7:"Larges mixtes", pn_pr8:"Larges tendres", pn_pr9:"Larges blindées", pn_r3:"Bras à ressort", pn_r4:"Vérin double", pn_a1:"Pare-choc", pn_a2:"Lame acier", pn_a3:"Fourche",
    pn_c0:"8-bit récupéré", pn_c1:"Cortex M7", pn_c2:"Pod neuronal",
    pn_n0:"Pare-chocs", pn_n1:"IR 360°", pn_n2:"LIDAR",
    pn_s0:"Réflexe v0", pn_s3:"Arbitrage v3", pn_s1:"Règles v1", pn_s2:"Tactique v2",
  ...
  en: {
    ...
    scrMetric:"{m} {v}{u} > max {c}{u}", scrPass:"Eligible", scrFail:"Not eligible", shopUsed:"Today's used deals", usedWear:"{w}% wear", usedSold:"Sold", scrTier:"{tr} tier required", scrCount:"{p} ×{n} > max ×{c}", dbTitle:"Debrief", dbBattery:"Battery left", dbDist:"Distance covered", dbContact:"Contact time", dbFlipped:"Time flipped", endShrinkOut:"sudden death (shrinking floor)", endRingOut:"ring-out", endKoFlip:"KO (flipped)", tournaments:"Tournaments", unlimited:"No limit", soon:"Coming soon", secLigues:"LEAGUES", enter:"Enter ›", lockedTag:"Locked", newTag:"New", nConcours:"{n} events", kEnCours:"{k} ongoing", enCours:"ongoing", engage:"Enter event", abandon:"Withdraw", confirmAbandon:"Confirm?", dispute:"Play round", freeFight:"Fight", youTag:"YOU", foeTag:"FOE", vsBehaviour:"BEHAVIOUR \u00B7 THIS BOUT", mancheN:"ROUND {r}/{n}", vsQual:"QUALIFIER", vsExhib:"EXHIBITION", hudBattery:"BATT", hudHealth:"HP", stickVersions:"Version plates", stickerAuto:"Free \u00B7 software", stickerWithSw:"With Software {v}", lockBeaten:"Record: {n} wins", needStar:"1\u2605 needed: {c}", lockStars:"Stars required in the previous league", lay_structure:"Structure", shopSerie:"Series", calibNote:"Measurement only \u00B7 no purse, no record", botExport:"Export bot", botImport:"Import a bot", botCopied:"Bot sheet copied", botImported:"{name} imported to the garage", botBadJson:"Unreadable sheet", setExchange:"Bot exchange", concoursOver:"Event over \u2014 re-enter to play again", introEyebrow:"GARAGE CIRCUIT", introTitle:"Welcome to the garage", introBody:"Your goal: become a sumo robot champion.<br><br>You start in class <b>S</b> \u2014 benchtop bots, 1.42 kg max on the scale. Win bouts in the <b>Garage Circuit</b>, upgrade part by part, and take the <b>Flea Cup</b>: the promotion bonus opens the M leagues.<br><br>A robot must pass the <b>tech check</b> to fight \u2014 the garage always tells you what\u2019s missing.", introGo:"LET\u2019S GO", recvEyebrow:"NEW CHASSIS", recvGo:"TO THE GARAGE", recvStarterSub:"Your first robot \u2014 built on a desk corner.", bareHullSub:"Bare hull \u2014 equip it before the tech check.", usedRecvSub:"Second-hand \u2014 assembled, worn, ready to roll.", ctOk:"TECH CHECK: FUNCTIONAL \u2713", addPart:"ADD COMPONENT", removePart:"REMOVE",  ct_propulsion:"Tech check: no drive (propulsion missing)", ct_motor:"Tech check: nothing spins (motor missing)", ct_battery:"Tech check: no juice (battery missing)", ct_cpu:"Tech check: nobody home (CPU missing)", ct_place:"Tech check: parts don\u2019t fit the hull",ct_worn:"Tech check: {p} worn out (100% wear)",saveReset:"Incompatible save version — starting fresh (the old save is backed up).",saveError:"Save failed — storage full? Play continues but is no longer being saved.",shopChassisAll:"See all chassis", bareHull:"{name} \u2014 bare hull delivered. Time to build!", welcomeEyebrow:"WHO\u2019S DRIVING TODAY?", careerNew:"NEW CAREER", careersBtn:"CAREERS", careerNamePh:"Career name", careerMeta:"Level {lv} \u00B7 {b} \u20AC \u00B7 {w} wins", classe:"Class", sPrime:"PROMOTION BONUS \u00B7 +200 \u20AC \u2014 a sponsor opens the M leagues!", lay_equipement:"Equipment", shopUsedBot:"Secondhand bot \u00B7 assembled", dmgTitle:"Damage report", dmgNone:"No notable damage", dmgHS:"DEAD", dmgRipped:"RIPPED OFF", dmgChassis:"Chassis", dmgRepairEst:"Repair estimate: {c} \u20AC", repair:"Repair {c} \u20AC", repairAll:"Repair all \u00B7 {c} \u20AC", wearPct:"wear {w} %", usedBotSold:"Sold \u2014 new offer tomorrow", usedBotBought:"Secondhand {name} in your garage \u2014 inspect it!", settingsTitle:"Settings", settingsEyebrow:"ROBOCLASH \u00B7 PWA", moreCtrlHint:"More controls unlock with software upgrades.", verRow_install:"Installable", verRow_maj:"Auto updates", forceUpdate:"Force update", updating:"Updating…", setLang:"Language", setVersions:"Versions", close:"Close", setErrlog:"Error log", errClear:"Clear log", errNone:"No errors recorded", verRow_build:"Build", verRow_off:"Offline", verRow_save:"Save format", verSaveV4:"instances", scrap:"Scrap", botScrapped:"{name} scrapped \u2014 parts returned to inventory", lastBot:"Cannot scrap your last bot", garageInv:"Inventory \u00B7 free parts", invEmpty:"No free parts \u2014 everything is fitted",invShop:"Inventory empty \u2014 hit the shop.", invNew:"new", shopChassis:"New chassis", champRound:"Round {r}/{n} · {rank}th", champTable:"Standings", you:"YOU", bracketNext:"Through · {r}", bracketChamp:"CHAMPION", bracketOut:"Eliminated", bracketPrize:"+{total} €", bracketTitle:"Cup M", bracketDone:"done", champDone:"Season over", champPrize:"{rank} in table · +{total} €", pn_a0:"(bare plate)", pn_m5:"µ-Servo 20", pn_m6:"µ-Torque 45", pn_pr4:"Rollers", pn_pr5:"Shielded rollers", pn_pr6:"Wide slicks", pn_pr7:"Wide all-round", pn_pr8:"Wide soft", pn_pr9:"Armoured wides", pn_r3:"Spring arm", pn_r4:"Dual ram", pn_a1:"Bumper", pn_a2:"Steel blade", pn_a3:"Fork",
    pn_c0:"Salvaged 8-bit", pn_c1:"Cortex M7", pn_c2:"Neural pod",
    pn_n0:"Bumpers", pn_n1:"IR 360°", pn_n2:"LIDAR",
    pn_s0:"Reflex v0", pn_s3:"Arbitration v3", pn_s1:"Rules v1", pn_s2:"Tactics v2",
...
const COMPONENT_SPRITES = {
  motor:{"m0":{src:"assets/m0.webp",w:120,h:101},"m1":{src:"assets/m1.webp",w:128,h:107},"m2":{src:"assets/m2.webp",w:128,h:100},"m3":{src:"assets/m3.webp",w:192,h:110},"m4":{src:"assets/m4.webp",w:192,h:156},"m5":{src:"assets/m5.webp",w:121,h:200},"m6":{src:"assets/m6.webp",w:215,h:400}},
  ...
  srimech:{"r1":{src:"assets/r1.webp",w:118,h:128},"r2":{src:"assets/r2.webp",w:192,h:113},"r3":{src:"assets/r3.webp",w:64,h:60},"r4":{src:"assets/r4.webp",w:60,h:129}},
  cooling:{"k0":{src:"assets/k0.webp",w:119,h:120},"k1":{src:"assets/k1.webp",w:128,h:106},"k2":{src:"assets/k2.webp",w:188,h:192}},
  propulsion:{"pr0":{src:"assets/pr0.webp",w:95,h:128},"pr1":{src:"assets/pr1.webp",w:106,h:256},"pr2":{src:"assets/pr2.webp",w:149,h:192},"pr3":{src:"assets/pr3.webp",w:110,h:320},"pr4":{src:"assets/pr4.webp",w:170,h:200},"pr5":{src:"assets/pr5.webp",w:166,h:200},"pr6":{src:"assets/pr6.webp",w:197,h:400},"pr7":{src:"assets/pr7.webp",w:182,h:400},"pr8":{src:"assets/pr8.webp",w:184,h:400}},
...
const CHASSIS_SERIES = {
  ...
  casse:  { id:"casse", order:2, accent:"#8a7f5a",     // tôle trouvée, peinture d'origine
           name:{ fr:"La Casse", en:"Scrap Run" },
           blurb:{ fr:"Ce qui tra\u00EEnait dans l'atelier, d\u00E9coup\u00E9 et reboulonn\u00E9. Lourd, laid, increvable \u00E0 sa fa\u00E7on.",
                   en:"Whatever was lying around the shop, cut and bolted back on. Heavy, ugly, tough in its own way." } },
  circuit:{ id:"circuit", order:3, accent:"#8fd46a",   // vert carte : l'électronique EST la structure
           name:{ fr:"Ligne Circuit", en:"Circuit Line" },
           blurb:{ fr:"La carte EST le ch\u00E2ssis. G\u00E9nial sur le papier, terrifiant au premier choc.",
                   en:"The board IS the chassis. Brilliant on paper, terrifying on first hit." } },
  hightech:{ id:"hightech", order:4, accent:"#5ec8d8", // composite usiné, tolérances serrées
           name:{ fr:"Haute Techno", en:"High Tech" },
           blurb:{ fr:"Composite usin\u00E9, tol\u00E9rances serr\u00E9es, catalogue international. L\u00E9ger et solide \u2014 et cher.",
                   en:"Machined composite, tight tolerances, international catalogue. Light and strong \u2014 and pricey." } },
};
...
const CHASSIS_REG = {
  ...
  /* E10 — DISQUE ramené en classe M : l'ancien masque comptait 52 cellules,
     au-dessus de la bande M (≤ 48) — il classait L alors qu'aucun contenu L
     n'existe. Pôles resserrés (2 cellules au lieu de 4) : 48 cellules pile,
     boîte 8×8 conservée (le sprite carré reste calé 1:1 sur l'empreinte). */
  disque: { series:"antan", tier:"beetle",
            spec:{ mask:["....##....","..######..",".########.",".########.",".########.",".########.","..######..","....##...."], front:0, rear:7 },
            info:{ name:"DISQUE", cost:420 },
            sprite:{ src:DISQUE_SRC, body:{x:30,y:31,w:449,h:448} } },
  /* ══ E4 — CLASSE S (Beetleweight 3 lb ≈ 1,36 kg à l'origine ; plafond porté à
   1,42 kg le 26/07 — décision Denis). Motif MESURÉ : à 1,36 le trio moteur +
   batterie + roues pesait 1,360 PILE, donc le moindre CPU (+10 g) ou capteur
   (+20 g) faisait sauter la pesée. La classe S ne pouvait pas s'offrir l'axe
   pilote sur ses coques lourdes. 1,42 ouvre pr1+c1+n1 sur losange_s et
   b1+pr1+c1+n1 sur hex_s et coin_s, sans rien changer aux pièces (ancres
   P-MASSE intactes) : c'est le RÈGLEMENT qui bouge, pas le matériel.
  ...
  /* ══ S30-ASSETS — douze coques S en trois séries (27/07). Toutes en 3×3 :
     masques dérivés de l'alpha (rastérisation 40 %, cellule la plus faible à 55 %),
     `body` = bornes alpha exactes (sprites recadrés), donc l'échelle largeur du
     rendu tombe à +0,1 % de l'empreinte. Les masses sont MESURÉES : aire alpha
     → cm² → tôle 2,5 mm × densité de la matière (voir tools/hull_masses.json).
     La matière vit dans ENGINE.CHASSIS, pas ici. ══ */
  /* E10 — LA CASSE : de la tôle trouvée, pas un catalogue. Presque gratuite
     et à PRIX UNIQUE (décision Denis 03/08) : la série d'entrée n'échelonne
     rien, elle dépanne. */
  boite_s:    { series:"casse", tier:"beetle",
            spec:{ mask:["###","###","###"], front:0, rear:2 },
            info:{ name:"BISCUIT S", cost:15 },
            sprite:{ src:"assets/boite_s.webp", body:{x:0,y:0,w:850,h:788} } },
  bois_s:     { series:"casse", tier:"beetle",
            spec:{ mask:["###","###","###"], front:0, rear:2 },
            info:{ name:"PLANCHE S", cost:15 },
            sprite:{ src:"assets/bois_s.webp", body:{x:0,y:0,w:850,h:798} } },
  fusible_s:  { series:"casse", tier:"beetle",
            spec:{ mask:["###","###","###"], front:0, rear:2 },
            info:{ name:"FUSIBLE S", cost:15 },
            sprite:{ src:"assets/fusible_s.webp", body:{x:0,y:0,w:850,h:749} } },
  couvercle_s:{ series:"casse", tier:"beetle",
            spec:{ mask:["###","###","###"], front:0, rear:2 },
            info:{ name:"COUVERCLE S", cost:15 },
            sprite:{ src:"assets/couvercle_s.webp", body:{x:0,y:0,w:810,h:850} } },
  hdd_s:      { series:"casse", tier:"beetle",
            spec:{ mask:["###","###","###"], front:0, rear:2 },
            info:{ name:"HDD S", cost:15 },
            sprite:{ src:"assets/hdd_s.webp", body:{x:0,y:0,w:823,h:850} } },
  bread_s:    { series:"circuit", tier:"beetle",
            spec:{ mask:["###","###","###"], front:0, rear:2 },
            info:{ name:"BREADBOARD S", cost:145 },
            sprite:{ src:"assets/bread_s.webp", body:{x:0,y:0,w:850,h:821} } },
  carte_s:    { series:"circuit", tier:"beetle",
            spec:{ mask:["###","###","###"], front:0, rear:2 },
            info:{ name:"CARTE S", cost:155 },
            sprite:{ src:"assets/carte_s.webp", body:{x:0,y:0,w:850,h:823} } },
  /* E10 — HAUTE TECHNO : échelle de prix CHINE → US → NIPPON → ITALIA →
     DEUTSCH (décision Denis 03/08). La boutique trie par coût : l'ordre
     d'affichage EST cette échelle. */
  chine_s:    { series:"hightech", tier:"beetle",
            spec:{ mask:["###","###","###"], front:0, rear:2 },
            info:{ name:"CHINE S", cost:175 },
            sprite:{ src:"assets/chine_s.webp", body:{x:0,y:0,w:850,h:808} } },
  us_s:       { series:"hightech", tier:"beetle",
            spec:{ mask:["###","###","###"], front:0, rear:2 },
            info:{ name:"US S", cost:195 },
            sprite:{ src:"assets/us_s.webp", body:{x:0,y:0,w:831,h:850} } },
  nippon_s:   { series:"hightech", tier:"beetle",
            spec:{ mask:["###","###","###"], front:0, rear:2 },
            info:{ name:"NIPPON S", cost:215 },
            sprite:{ src:"assets/nippon_s.webp", body:{x:0,y:0,w:824,h:850} } },
  italia_s:   { series:"hightech", tier:"beetle",
            spec:{ mask:["###","###","###"], front:0, rear:2 },
            info:{ name:"ITALIA S", cost:235 },
            sprite:{ src:"assets/italia_s.webp", body:{x:0,y:0,w:805,h:850} } },
  deutsch_s:  { series:"hightech", tier:"beetle",
            spec:{ mask:["###","###","###"], front:0, rear:2 },
            info:{ name:"DEUTSCH S", cost:255 },
            sprite:{ src:"assets/deutsch_s.webp", body:{x:0,y:0,w:850,h:839} } },
...
const TOURNAMENTS = [
  { id:"sumoS", arena:"assets/arena_s_nerd.webp", name:{fr:"Defi du Bureau",en:"Desk Challenge"}, format:"championnat", rounds:4,
    ...
    rules:{ tier:"beetle", chassisClass:"S", banWeapons:true, banTracks:true, mode:"sumo",
            maxSoftware:"s1", metrics:{ weightKg:1.42 }, maxCount:{ motor:1, battery:1 } } },
  { id:"sparS", arena:"assets/arena_clean.webp", name:{fr:"Sparring d'Atelier",en:"Workshop Sparring"}, format:"championnat", rounds:6,
    unlock:null, lockBuild:true,
    rules:{ tier:"beetle", chassisClass:"S", banWeapons:true, banTracks:true, mode:"sumo",
            maxSoftware:"s1", metrics:{ weightKg:1.42 }, maxCount:{ motor:1, battery:1, cooling:1, ballast:1 } } },
  ...
  { id:"cupM", arena:"assets/arena_grim.webp", name:{fr:"Coupe M",en:"Cup M"}, format:"bracket", size:16,
    ...
    rules:{ tier:"beetle", chassisClass:"M", banWeapons:true, mode:"sumo",
            metrics:{ weightKg:5.44 }, maxCount:{ motor:3, battery:3 } } },
  { id:"etalS1", arena:"assets/arena_s_nerd.webp", name:{fr:"Étalon S1",en:"Standard S1"}, format:"libre",
    unlock:null, lockBuild:false, noEngage:true, noStars:true, benchmark:"S1",
    rules:{ tier:"beetle", chassisClass:"S", banWeapons:true, mode:"sumo" } },
  { id:"etalS2", arena:"assets/arena_s_nerd.webp", name:{fr:"Étalon S2",en:"Standard S2"}, format:"libre",
    unlock:null, lockBuild:false, noEngage:true, noStars:true, benchmark:"S2",
    rules:{ tier:"beetle", chassisClass:"S", banWeapons:true, mode:"sumo" } },
  { id:"etalS3", arena:"assets/arena_s_nerd.webp", name:{fr:"Étalon S3",en:"Standard S3"}, format:"libre",
    unlock:null, lockBuild:false, noEngage:true, noStars:true, benchmark:"S3",
    rules:{ tier:"beetle", chassisClass:"S", banWeapons:true, mode:"sumo" } },
  { id:"etalM1", arena:"assets/arena_clean.webp", name:{fr:"Étalon M1",en:"Standard M1"}, format:"libre",
    unlock:null, lockBuild:false, noEngage:true, noStars:true, benchmark:"M1",
    rules:{ tier:"beetle", chassisClass:"M", banWeapons:true, mode:"sumo" } },
  { id:"etalM2", arena:"assets/arena_clean.webp", name:{fr:"Étalon M2",en:"Standard M2"}, format:"libre",
    unlock:null, lockBuild:false, noEngage:true, noStars:true, benchmark:"M2",
    rules:{ tier:"beetle", chassisClass:"M", banWeapons:true, mode:"sumo" } },
  { id:"etalM3", arena:"assets/arena_clean.webp", name:{fr:"Étalon M3",en:"Standard M3"}, format:"libre",
    unlock:null, lockBuild:false, noEngage:true, noStars:true, benchmark:"M3",
    rules:{ tier:"beetle", chassisClass:"M", banWeapons:true, mode:"sumo" } },
  { id:"etalM4", arena:"assets/arena_clean.webp", name:{fr:"Étalon M4",en:"Standard M4"}, format:"libre",
    unlock:null, lockBuild:false, noEngage:true, noStars:true, benchmark:"M4",
    rules:{ tier:"beetle", chassisClass:"M", banWeapons:true, mode:"sumo" } },
  { id:"etalM5", arena:"assets/arena_clean.webp", name:{fr:"Étalon M5",en:"Standard M5"}, format:"libre",
    unlock:null, lockBuild:false, noEngage:true, noStars:true, benchmark:"M5",
    rules:{ tier:"beetle", chassisClass:"M", banWeapons:true, mode:"sumo" } },
  /* ══ LIGUE OUVERTE (CAP 26/07) — mixte par son PROGRAMME, jamais par le ring.
     Chaque épreuve reste MONO-classe et garde le ring de sa classe : un S ne
     rencontre JAMAIS un M. Le caractère de la ligue tient au règlement — les
     épreuves S bridents le MATÉRIEL et laissent le logiciel libre, les M
     bridents le LOGICIEL et laissent le matériel libre. Deux philosophies de
     build, une seule ligue, zéro champ nouveau. ══ */
  { id:"ouvS1", arena:"assets/arena_s_nerd.webp", name:{fr:"Duel de Precision",en:"Precision Duel"}, format:"championnat", rounds:5,
    unlock:null, lockBuild:true,
    rules:{ tier:"beetle", chassisClass:"S", banWeapons:true, banTracks:true, mode:"sumo",
            metrics:{ weightKg:1.20 }, maxCount:{ motor:1, battery:1 } } },
  { id:"ouvS2", arena:"assets/arena_grim.webp", name:{fr:"Coupe Micro",en:"Micro Cup"}, format:"bracket", size:8,
    unlock:null, lockBuild:true,
    rules:{ tier:"beetle", chassisClass:"S", banWeapons:true, banTracks:true, mode:"sumo",
            metrics:{ weightKg:1.30 }, maxCount:{ motor:1, battery:1 } } },
  { id:"ouvM1", arena:"assets/arena_m_shop.webp", name:{fr:"Poids Lourds",en:"Heavyweights"}, format:"championnat", rounds:7,
    unlock:null, lockBuild:true,
    rules:{ tier:"beetle", chassisClass:"M", banWeapons:true, mode:"sumo",
            maxSoftware:"s0", metrics:{ weightKg:5.44 }, maxCount:{ motor:3, battery:3 } } },
  { id:"ouvM2", arena:"assets/arena_grim.webp", name:{fr:"Coupe Ouverte",en:"Open Cup"}, format:"bracket", size:16,
    unlock:null, lockBuild:true,
    rules:{ tier:"beetle", chassisClass:"M", banWeapons:true, mode:"sumo",
            maxSoftware:"s1", metrics:{ weightKg:5.44 }, maxCount:{ motor:3, battery:3 } } },
  { id:"libre", arena:"assets/arena_kawaii.webp", name:{fr:"Combat libre",en:"Free Fight"}, format:"libre",
    unlock:null, lockBuild:false, noEngage:true, noStars:true,   // exhibition : ni engagement, ni progression
    rules:{ tier:"beetle" } }];
...
const LIGUES = [
  ...
  { id:"ouverte", name:{fr:"Ligue Ouverte",en:"Open League"}, tier:"beetle", unlock:null, purseMult:1.6,
    concours:["ouvS1","ouvS2","ouvM1","ouvM2"] },
  /* CALIBRAGE — la règle graduée. Adversaires ENTIÈREMENT figés (ENGINE.BENCHMARKS),
     zéro tirage : deux mesures prises à un mois d'écart sont comparables. Aucune
     bourse, aucun palmarès : le calibrage MESURE, il ne récompense pas. */
  { id:"calibrage", name:{fr:"Ligne Calibrage",en:"Calibration Line"}, tier:"beetle", unlock:null, purseMult:0, noStars:true,
    concours:["etalS1","etalS2","etalS3","etalM1","etalM2","etalM3","etalM4","etalM5"] },
