...
## 🔴 Highest impact — accents are stripped
...
1. **Too many type styles, low legibility.** Pixel font + condensed sans + a
   ...
   numbers.
2. **ALL-CAPS + stripped accents on body/coaching text** (debrief coaching, CT
   errors) — walls of caps. Sentence case reads far better.
