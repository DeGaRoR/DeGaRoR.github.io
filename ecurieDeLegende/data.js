...
{id:"rocio",nom:"Rocío l'Andalouse",rarete:"legendaire",emoji:"🤍",image:IMG.rocio,desc:"Le cheval royal d'Espagne, de Pure Race Espagnole. Grise virant au blanc, au long crin ondulé, elle sait danser. Ses cousins sont partis sur les bateaux devenir les premiers chevaux d'Amérique !",aff:["beaute","vitesse"],familles:["mascotte","legende"],royaume:"espagne"},
  ...
  {id:"cheval_pale_mort",nom:"Le cheval pâle de la Mort",rarete:"celeste",emoji:"💀",image:IMG.cheval_pale_mort,desc:"Monture spectrale du dernier des cavaliers, elle avance là où tout s'éteint.",aff:["magie","bataille"],familles:["legende"],royaume:"outremonde"},
  {id:"cheval_rouge_guerre",nom:"Le cheval rouge de la Guerre",rarete:"celeste",emoji:"🔥",image:IMG.cheval_rouge_guerre,desc:"Étalon de flammes du cavalier de la Guerre, il enflamme les champs de bataille.",aff:["bataille","force"],familles:["bataille"],royaume:"outremonde"},
...
const JALONS=[
  ...
  {carte:'mythe_grand_maitre',   txt:'Maîtriser le pack Mythologie',     cond:()=>mythoMaitrise()},
];
...
/* Pack Mythologie — épreuve de maîtrise (run parfait de 10, 3 niveaux, légendaire à la clé) */
const MYTHO_THEO=["Bienvenue dans la grande épreuve des mythes ! Ce premier niveau réunit les chevaux les plus célèbres de l'Antiquité.\n\n🇬🇷 Dans la Grèce antique : PÉGASE, le cheval ailé né du sang de Méduse, monture du héros Bellérophon. ARÉION, le cheval noir immortel né de Poséidon, si rapide qu'aucun mortel ne l'attrape. XANTHOS et BALIOS, les deux chevaux immortels d'Achille. Et l'HIPPOCAMPE, mi-cheval mi-poisson, qui tire le char des dieux marins.\n\n⚡ Dans le Nord viking : SLEIPNIR, le cheval à HUIT pattes du dieu Odin, le plus rapide des neuf mondes.\n\n✨ On croise aussi la LICORNE (cheval blanc à corne magique), le CENTAURE (mi-homme mi-cheval), et BUCÉPHALE, le fougueux cheval noir qu'Alexandre le Grand fut le seul à dompter.","Niveau 2 : les chevaux de l'eau ! Dans les légendes celtiques, méfie-toi des chevaux qui surgissent près des lacs et de la mer…\n\n🌊 Le KELPIE d'Écosse a une crinière ruisselante ; il invite les voyageurs à monter sur son dos… puis plonge avec eux au fond du loch ! L'EACH-UISGE est son cousin encore plus redoutable des lochs et de la mer. Sur l'île de Man rôde le CABYLL-USHTEY, et au pays de Galles le CEFFYL DŴR, né de la brume des cascades.\n\n🍀 En Irlande, le PÚCA est un esprit farceur en forme de cheval noir aux yeux d'or, et LIATH MACHA, « le Gris de Macha », fut le fidèle cheval de guerre du héros Cúchulainn.\n\n⛵ En Bretagne, MORVARC'H, le cheval-marin du roi Gradlon, galope sur les vagues. Et jusqu'au Chili, le CABALLO MARINO nage avec sa nageoire dorée.","Niveau 3, le plus difficile : les chevaux mythiques du monde entier !\n\n🐎 Chez les peuples des steppes turques vole le TULPAR, cheval ailé qui bondit d'un sommet à l'autre. Le peuple bachkir raconte AKBUZAT, un destrier céleste tombé du ciel, et les Kirghizes chantent AK-KULA, le cheval du héros Manas.\n\n🌏 En Extrême-Orient galope le CHOLLIMA, cheval ailé parcourant des centaines de kilomètres en un jour. Au Japon, AME-NO-FUCHIKOMA est le cheval céleste à la robe pie du dieu Susanoo. En Perse, SHABDIZ (« Minuit ») était le cheval noir le plus rapide du roi Khosro.\n\n🌌 Et dans le ciel nordique : GULLFAXI (« crinière d'or »), HRÍMFAXI (« crinière de givre », cheval de la Nuit), SKINFAXI (« crinière brillante », cheval du Jour) et SVAÐILFARI, l'étalon qui bâtit les murs d'Asgard et fut le père de Sleipnir."];
const BANK_MYTHO_1=[
 {q:"Combien de pattes possède Sleipnir, le cheval du dieu Odin ?",r:"huit",choix:["huit","quatre","six","dix"],e:"Sleipnir est le célèbre cheval à huit pattes de la mythologie nordique."},
 {q:"De quel dieu grec de la mer Aréion est-il le fils ?",r:"Poséidon",choix:["Poséidon","Zeus","Arès","Hadès"]},
 {q:"Pégase, le cheval ailé, est né du sang de quelle créature ?",r:"Méduse",choix:["Méduse","l'Hydre","le Minotaure","le Cyclope"],e:"Il jaillit du cou de Méduse quand Persée la décapita."},
 {q:"Quel roi de l'Antiquité fut le seul à dompter Bucéphale ?",r:"Alexandre le Grand",choix:["Alexandre le Grand","Jules César","Léonidas","Ulysse"]},
 {q:"Qu'est-ce qu'un hippocampe dans la mythologie grecque ?",r:"un cheval-poisson",choix:["un cheval-poisson","un cheval ailé","un cheval de feu","un cheval géant"]},
 {q:"À quoi reconnaît-on une licorne ?",r:"à sa corne unique",choix:["à sa corne unique","à ses ailes","à ses huit pattes","à ses écailles"]},
 {q:"Un centaure est mi-homme et mi-…",r:"cheval",choix:["cheval","taureau","lion","poisson"]},
 {q:"À quelle mythologie appartient Sleipnir ?",r:"nordique",choix:["nordique","grecque","égyptienne","japonaise"]},
 {q:"Que sont Xanthos et Balios pour le héros Achille ?",r:"ses chevaux immortels",choix:["ses chevaux immortels","ses frères","ses armes","ses chiens"]},
 {q:"Pégase servait de monture à quel héros grec ?",r:"Bellérophon",choix:["Bellérophon","Hercule","Dédale","Jason"],e:"Bellérophon le chevaucha pour vaincre la Chimère."}
];
const BANK_MYTHO_2=[
 {q:"Que fait le Kelpie aux voyageurs qui montent sur son dos ?",r:"il plonge avec eux dans l'eau",choix:["il plonge avec eux dans l'eau","il les ramène chez eux","il s'envole","il devient un poisson"]},
 {q:"De quel pays viennent les légendes du Kelpie ?",r:"l'Écosse",choix:["l'Écosse","l'Italie","la Grèce","le Japon"]},
 {q:"Le Púca irlandais prend la forme d'un cheval noir aux yeux…",r:"d'or",choix:["d'or","rouges","bleus","verts"]},
 {q:"Liath Macha était le cheval de guerre de quel héros irlandais ?",r:"Cúchulainn",choix:["Cúchulainn","le roi Arthur","Achille","Roland"]},
 {q:"Morvarc'h, le cheval-marin du roi Gradlon, vient de quelle région ?",r:"la Bretagne",choix:["la Bretagne","la Sicile","la Norvège","l'Égypte"]},
 {q:"Le Ceffyl Dŵr est un cheval d'eau de quel pays ?",r:"le pays de Galles",choix:["le pays de Galles","le Portugal","le Danemark","le Maroc"]},
 {q:"Où vit le Caballo Marino à la nageoire dorée ?",r:"au Chili",choix:["au Chili","en Islande","en Chine","en Grèce"]},
 {q:"Qu'ont en commun le Kelpie, l'Each-Uisge et le Cabyll-Ushtey ?",r:"ce sont des chevaux d'eau",choix:["ce sont des chevaux d'eau","ce sont des chevaux ailés","ils crachent du feu","ils ont huit pattes"]},
 {q:"« Liath Macha » signifie « le Gris de Macha ». De quelle couleur est ce cheval ?",r:"gris",choix:["gris","noir","blanc","alezan"]},
 {q:"L'Each-Uisge hante surtout…",r:"les lochs et la mer",choix:["les lochs et la mer","les déserts","les montagnes enneigées","les grandes villes"]}
];
const BANK_MYTHO_3=[
 {q:"Le Tulpar, cheval ailé, vient des légendes de quels peuples ?",r:"des steppes turques",choix:["des steppes turques","d'Afrique","d'Amazonie","du Groenland"]},
 {q:"Que peut faire le Chollima en un seul jour ?",r:"parcourir des centaines de km",choix:["parcourir des centaines de km","voler jusqu'à la Lune","dormir sans fin","changer de couleur"],e:"Son nom évoque « mille lis », une très longue distance."},
 {q:"« Skinfaxi » (crinière brillante) est le cheval de quoi ?",r:"du Jour",choix:["du Jour","de la Nuit","du Feu","du Vent"]},
 {q:"« Hrímfaxi » (crinière de givre) est le cheval de quoi ?",r:"de la Nuit",choix:["de la Nuit","du Jour","de la Mer","de la Guerre"]},
 {q:"De quel cheval très célèbre Svaðilfari est-il le père ?",r:"Sleipnir",choix:["Sleipnir","Pégase","Bucéphale","Gullfaxi"],e:"Svaðilfari est aussi l'étalon qui bâtit les murs d'Asgard."},
 {q:"Shabdiz, dont le nom signifie « Minuit », était de quelle couleur ?",r:"noir",choix:["noir","blanc","doré","gris"]},
 {q:"Ame-no-Fuchikoma est le cheval céleste d'un dieu de quel pays ?",r:"le Japon",choix:["le Japon","la Perse","la Grèce","l'Irlande"]},
 {q:"« Gullfaxi » signifie « crinière… »",r:"d'or",choix:["d'or","de givre","de feu","d'argent"]},
 {q:"Ak-Kula est le fidèle cheval du héros Manas, dans l'épopée…",r:"kirghize",choix:["kirghize","romaine","égyptienne","aztèque"]},
 {q:"Le Chollima est un cheval…",r:"ailé",choix:["ailé","marin","de trait","invisible"]}
];
const PACKS=[
...
iberie:{img:'cartes/rocio.jpg',ecrans:["¡Hola ! Moi c'est Rocío, jument Andalouse de Pure Race Espagnole — la fierté de l'Ibérie ! 🤍","Le savais-tu ? Je suis née pour danser : on m'entraîne à la haute école, ces pas majestueux qu'on admire dans les arènes et les fêtes. Fière, élégante et incroyablement docile.","Chez moi, en Andalousie, mes ancêtres portaient les rois et les conquistadors. On m'a exportée partout dans le monde — je suis l'ancêtre de dizaines de races, du Lipizzan au Lusitanien !"]}
};
