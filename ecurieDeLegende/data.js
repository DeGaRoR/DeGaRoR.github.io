...
{id:"rocio",nom:"Rocío l'Andalouse",rarete:"legendaire",emoji:"🤍",image:IMG.rocio,desc:"Le cheval royal d'Espagne, de Pure Race Espagnole. Grise virant au blanc, au long crin ondulé, elle sait danser. Ses cousins sont partis sur les bateaux devenir les premiers chevaux d'Amérique !",aff:["beaute","vitesse"],familles:["mascotte","legende"],royaume:"espagne"},
  ...
  {id:"equit_polo",nom:"Le poney de polo",rarete:"rare",emoji:"🥍",image:IMG.equit_polo,desc:"Vif comme l'éclair, il pivote et sprinte au son du maillet.",aff:["vitesse"],familles:["course"],royaume:"argentine"},
  {id:"equit_enduro",nom:"Le cheval d'endurance",rarete:"rare",emoji:"🏁",image:IMG.equit_enduro,desc:"Cent kilomètres sous le soleil : rien n'arrête ce marathonien.",aff:["endurance"],familles:["course"],royaume:"arabie"},
  {id:"equit_attelage",nom:"Le cheval d'attelage sportif",rarete:"rare",emoji:"🛞",image:IMG.equit_attelage,desc:"Entre les cônes, au galop : la précision d'un athlète attelé.",aff:["force","vitesse"],familles:["course","travail"],royaume:"hongrie"},
  ...
  {id:"equit_dressage",nom:"Le cheval de dressage",rarete:"epique",emoji:"🎩",image:IMG.equit_dressage,desc:"Un danseur : chaque pas est une figure, sous les ors du manège.",aff:["beaute"],familles:["course","race"],royaume:"autriche"},
